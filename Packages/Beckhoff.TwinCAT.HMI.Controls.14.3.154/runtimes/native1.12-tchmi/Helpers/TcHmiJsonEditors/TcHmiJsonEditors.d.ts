...
declare namespace TcHmi.Controls.Helpers {
    ...
    class SchemaParser {
        ...
        /**
         * Returns an array of schemas that should be merged.
         * @param schema The schema to search for allOf properties.
         */
        private static __getAllOfSchemas;
        /**
         ...
         */
        static generateName(schema: JsonSchema | {
            title?: string;
            id?: string;
            type?: string;
        }): string;
